...
// console.log(centerString(calMonthTitleStr,calWidth))
// console.log(dayLine())
// console.log(lineBreaks(daysInMonthStr))

process.stdout.write(`${centerString(calMonthTitleStr,calWidth).trimRight()}\n`)
process.stdout.write(`${dayLine().trimRight()}\n`)
process.stdout.write(`${lineBreaks(daysInMonthStr)}\n\n`)
